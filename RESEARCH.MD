...
работать аппликативно.

Отложенный порядок вычисления можно использовать с помощью ключевого
слова `lazy`. Класс `Lazy` хранит значение выражения и функцию, 
...
Когда дело доходит до вычисления символических выражений
...
Lazy(_eval=<spsp.evaluation.Function object at 0x0000028C4E9ED250>, _value=<object object at 0x0000028C4E0C49E0>)
>>> (let z (lazy (do (print "Calc z") (* 2 y)))) 
Lazy(_eval=<spsp.evaluation.Function object at 0x0000028C4E9EDE50>, _value=<object object at 0x0000028C4E0C49E0>)
>>> (let t (lazy (do (print "Calc t") (- z y)))) 
Lazy(_eval=<spsp.evaluation.Function object at 0x0000028C4E9EEA10>, _value=<object object at 0x0000028C4E0C49E0>)
>>> (print t)                                    
Calc t
Calc z
Calc y
...
При повторном обращении к переменной, она не будет вычисляться заного:
```lisp
>>> (def use [x]                                              
...   (do               
...     (print 'text before calculation')
...     (print (+ 1 x))))
<spsp.evaluation.Function object at 0x000001C590DF9290>
>>> (let y (lazy (do (import time) (print 'hard function') (time::sleep 5) 41)))
Lazy(_eval=<spsp.evaluation.Function object at 0x000001C590DFA150>, _value=<object object at 0x000001C5904D49C0>)
>>> (use y)
text before calculation
hard function
42
None
>>> (use y)
...
Lazy(_eval=<spsp.evaluation.Function object at 0x000001D5BBFBE1D0>, _value=<object object at 0x000001D5BB6949E0>)
>>> (+ y 1)                         
42
```
