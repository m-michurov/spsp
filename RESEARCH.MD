...
Логические связки `and` ([определение](std-lib.spsp#L31-L42)) и `or` ([определение](std-lib.spsp#L44-L55)) реализованы через макросы. Они получаются ленивые, потому что 
